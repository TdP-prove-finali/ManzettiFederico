...
public class WorkStation {
	...
	//probabilità in caso di rilavorazione
	...
	public WorkStation(String nome,  double t0, double c0, int m) {
		...
		//i tre casi sono dati come inesistenti poichè inizializziamo la workstation come se fosse una macchina
		//ideale
		guasti=false;
		setup=false;
		rilavorazioni=false;
...
//i metodi Is"-" servono a verificare la natura della workstation (e quali parametri utilizzare per valutarne le prestazioni)
